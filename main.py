...
os.environ['KAGGLE_CONFIG_DIR'] = 'secure directory'  # Update this path to your Kaggle configuration directory

# Specify the dataset identifier
dataset = 'piterfm/paris-2024-olympic-summer-games'

# Set the download path
download_path = 'source path' # Change this to your preferred download directory
